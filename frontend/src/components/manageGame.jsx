...
import { getAll, getQuestions, playLogo, resetAll, showBackground, showBackground2, showCaspar, showCaspar2, showCorrectOption, showCorrectOption2, showScore, showScore2, stopBackground, stopBackground2, stopLogo, stopQ, stopQ2, stopScore, stopScore2 } from "../api/context";
    ...
    return (
        <div className="manage-game">
            ...
            <div className="game-panel">
                <div className="realtime-questions">
